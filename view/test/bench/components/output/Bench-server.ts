...
const Bench = {
	...
	render: ($props: any, $context: Record<PropertyKey, any>, $slots: Record<string, SlotRender>) => {
		...
		for (let row of $state.data) {
			$output += `<!^>  <tr selected="$state.selected === row.id"> <td class="col-md-1">${t_fmt(row.id)}</td> <td class="col-md-4"> <a> ${t_fmt(row.label)} </a> </td> <td class="col-md-1"> <a> <span class="glyphicon glyphicon-remove" aria-hidden="true"/> </a> </td> <td class="col-md-6"/> </tr> `;
		}
