...
const For = {
  ...
  */
  render: ($parent, $anchor, $props, $slots, $context) => {
    ...
    const t_for_parent_1 = t_root(t_fragment_0);
    const t_for_anchor_1 = t_anchor(t_next(t_child(t_div_1)));
    ...
    t_run_list(
      ...
      function createListItem(t_item, t_before) {
        ...
        $run(function setTextContent() {
          ...
          t_text_1.textContent = t_fmt(item.text);
        });
    ...
    t_apply_props(t_div_1, $props, ['items']);
