...
describe("SelectBox", () => {
	it("Keyboard", async () => {
		...
		//   popup
		fireEvent(button, new KeyboardEvent("keydown", { key: "ArrowDown", bubbles: true }));
		...
		expect(list).toHaveAttribute("aria-hidden", "true");
		fireEvent(button, new KeyboardEvent("keydown", { key: "ArrowUp", bubbles: true }));
