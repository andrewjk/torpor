...
export const defaultPalette: string[] = [
	"#FFFFFF", "#F5F5F5", "#D9D9D9", "#BFBFBF", "#8C8C8C",
	"#595959", "#404040", "#262626", "#0F0F0F", "#000000",
	"#FFE4E1", "#FFC0CB", "#FF7F7F", "#FF4040", "#E60000",
	"#A61C00", "#FFEDCC", "#FFD59E", "#FFAA33", "#E67E00",
	"#B35900", "#FFF9C4", "#FFF176", "#FFEB3B", "#FBC02D",
	"#F9A825", "#827717", "#E8F5E9", "#A5D6A7", "#66BB6A",
	"#2E7D32", "#1B5E20", "#0D47A1", "#1565C0", "#1E88E5",
	"#42A5F5", "#90CAF9", "#E1BEE7", "#CE93D8", "#AB47BC",
	"#8E24AA", "#4A148C",
];
