...
export default function DeepMixed(
								...
								if ($props.d) {
									...
									t_run_control(t_if_region_5, t_if_anchor_5, (t_before) => {
										if ($props.e) {
											...
											const t_p_1 = t_root(t_fragment_5) as HTMLElement;
											t_add_fragment(t_fragment_5, t_fragment_4, t_before, t_p_1);
											t_next(t_p_1);
	...
	t_run_control(t_if_region_6, t_if_anchor_6, (t_before) => {
		if ($props.a && $props.e) {
			...
			const t_p_2 = t_root(t_fragment_6) as HTMLElement;
			t_add_fragment(t_fragment_6, t_fragment_0, t_before, t_p_2);
			t_next(t_p_2);
			t_pop_region(t_old_region);
			t_if_index_6 = 0;
		}
