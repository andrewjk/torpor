...
export default function ForSwitchFor(
	...
	t_run_list(
		...
		(t_item_1, t_before_1) => {
			...
			const t_div_1 = t_root(t_fragment_1) as HTMLDivElement;
			let t_switch_anchor_1 = t_anchor(t_child(t_div_1)) as HTMLElement;
			...
			t_run_control(t_switch_region_1, t_switch_anchor_1, (t_before) => {
				switch ($props.operation) {
					case "sum": {
						...
						t_add_fragment(t_fragment_2, t_div_1, t_before, t_p_1);
						t_next(t_p_1);
					...
					case "max": {
						...
						t_add_fragment(t_fragment_3, t_div_1, t_before, t_p_2);
						t_next(t_p_2);
						t_pop_region(t_old_region);
						t_switch_index_1 = 1;
						break;
					...
					case "items": {
						...
						let t_for_anchor_2 = t_anchor(t_root(t_fragment_4)) as HTMLElement;
						...
						t_run_list(
							...
							(t_item_2, t_before_2) => {
								...
								const t_span_1 = t_root(t_fragment_5) as HTMLSpanElement;
								const t_text_3 = t_child(t_span_1);
								$run(() => {
									t_text_3.textContent = `${t_fmt(t_item_2.data.cell)} `;
								});
								t_add_fragment(t_fragment_5, t_fragment_4, t_before_2, t_span_1);
								t_next(t_span_1);
					...
					default: {
						...
						const t_p_3 = t_root(t_fragment_6) as HTMLElement;
						t_add_fragment(t_fragment_6, t_div_1, t_before, t_p_3);
						t_next(t_p_3);
						t_pop_region(t_old_region);
						t_switch_index_1 = 3;
						break;
			...
			t_add_fragment(t_fragment_1, t_fragment_0, t_before_1, t_div_1);
			t_next(t_div_1);
