...
export default function StreamResubscribe(
	...
	const t_fragment_0 = t_fragment($parent.ownerDocument!, t_fragments, 0, `<button>Switch</button> <ul><!></ul>`);
	...
	t_event(t_button_1, "click", () => { $state.channel = "b" });
