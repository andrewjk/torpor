...
export default function Shape(
	...
	t_run_control(t_if_region_1, t_if_anchor_1, (t_before) => {
		if ($props.name === "rect") {
			...
			const t_rect_1 = t_root(t_fragment_1) as SVGRectElement;
			t_add_fragment(t_fragment_1, t_svg_1, t_before, t_rect_1);
			t_next(t_rect_1);
			...
			const t_circle_1 = t_root(t_fragment_2) as HTMLElement;
			t_add_fragment(t_fragment_2, t_svg_1, t_before, t_circle_1);
			t_next(t_circle_1);
			t_pop_region(t_old_region);
			t_if_index_1 = 1;
		}
