...
export default function Class(
	...
	const t_a_1 = t_next(t_next(t_next(t_next(t_next(t_child(t_next(t_root_0))), true)), true)) as HTMLElement;
	...
	const t_comp_anchor_1 = t_anchor(t_next(t_next(t_div_4, true))) as HTMLElement;
