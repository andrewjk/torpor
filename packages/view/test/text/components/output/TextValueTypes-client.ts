...
export default function TextValues(
	...
	const t_text_5 = t_child(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_root_0), true)), true)), true)), true)));
	const t_text_6 = t_child(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_root_0), true)), true)), true)), true)), true)));
	const t_text_7 = t_child(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_root_0), true)), true)), true)), true)), true)), true)));
	const t_text_8 = t_child(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_root_0), true)), true)), true)), true)), true)), true)), true)));
	const t_text_9 = t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_next(t_root_0), true)), true)), true)), true)), true)), true)), true)), true);
	$run(() => {
	...
	t_add_fragment(t_fragment_0, $parent, $anchor, t_text_9);
	t_next(t_text_9);
