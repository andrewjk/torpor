...
import findTorporPackages, {
	addTorporPackageConfig,
} from "../src/utils/torporPackages";
...
beforeAll(() => {
	...
	write("node_modules/fake-icons/package.json", JSON.stringify({
			name: "fake-icons",
			torpor: "./index.js",
	...
	write("node_modules/nested-icons/package.json", JSON.stringify({
			name: "nested-icons",
			exports: { ".": "./index.torp" },
		}));
	...
	write("node_modules/@scope/icons/package.json", JSON.stringify({
			name: "@scope/icons",
			exports: { ".": "./icon.torp" },
		}));
	...
	write("node_modules/plain-lib/package.json", JSON.stringify({ name: "plain-lib", exports: { ".": "./index.js" } }));
...
test("findTorporPackages -- skips Node builtin shadowing deps", () => {
	...
	write("node_modules/builtin-shadow/package.json", JSON.stringify({
			name: "builtin-shadow",
